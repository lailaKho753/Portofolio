...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/exp">Experience and Project</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/skill">Skill</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/sertif">Certification</a></li>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Laila 2022</small></div>
        </div>
        <!-- Bootstrap core JS-->
